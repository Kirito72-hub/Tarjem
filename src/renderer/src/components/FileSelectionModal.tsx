          ...
          {files.map((file, index) => (
            ...
            >
              <div className="w-10 flex justify-center shrink-0">
                <div
                  className={`transition-colors ${file.checked ? 'text-purple-500' : 'text-gray-600 group-hover:text-gray-400'}`}
                >
              ...
              <div className="flex-1 px-2 min-w-0 flex items-center gap-3">
                <FileVideo
                  size={18}
                  className={file.checked ? 'text-purple-400' : 'text-gray-600'}
                />
                <span
                  className={`text-sm truncate ${file.checked ? 'text-gray-200' : 'text-gray-400'}`}
                >
                  {file.name}
                </span>
              </div>
              ...
              <div className="w-24 px-2 text-center text-xs text-gray-600 shrink-0">MKV/MP4</div>
            </div>
          ))}
        </div>
