        ...
        <div className="p-6">
           <div className="mb-6">
             <p className="text-gray-400 text-sm">
               You are about to process <span className="text-white font-medium">{fileCount} files</span>. 
               Configure how FFmpeg should handle streams.
             </p>
           </div>
             ...
             >
                ...
                <div className="flex-1">
                   ...
                   <p className="text-xs text-gray-500 leading-relaxed">
                     Deletes all hard-coded or embedded subtitle tracks from the source video to prevent duplicates.
                   </p>
                </div>
             </div>
